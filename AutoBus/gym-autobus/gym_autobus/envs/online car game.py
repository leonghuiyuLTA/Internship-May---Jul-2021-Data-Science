...
class Car(pygame.sprite.Sprite):
    def __init__(self, surface):
        ...
        self.rect.centerx = self.bounded_rect.width / 4
...
class CarGame(object):
    ...
    def __init__(self, width=320, height=400):
        # Initialize the game
        pygame.init()
        ...
        self.paint_middle_line = width - self.MIDDLE_LINE_GAP
    ...
    #
        ...
        if self.paint_middle_line == self.MIDDLE_LINE_LENGTH:
            self.paint_middle_line = self.width - self.MIDDLE_LINE_GAP
